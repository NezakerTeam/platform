        ...
        <div class="row"> 
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                <ul class="nav nav-tabs custom-nav-tabs" role="tablist">
                    <li class="active" role="presentation"><a href="#graphicesigning" aria-controls="graphicesigning" role="tab" data-toggle="tab">تسجيل المعلم</a></li>
                    <li role="presentation"><a href="#onlinemarketing" aria-controls="onlinemarketing" role="tab" data-toggle="tab">كيف تقوم بتصوير الدروس؟</a></li>
                    <li role="presentation"><a href="#brandstrategy" aria-controls="brandstrategy" role="tab" data-toggle="tab">أرسال فيديو</a></li>
                    <li role="presentation"><a href="#generalmedicine" aria-controls="generalmedicine" role="tab" data-toggle="tab">مراجع الفيديو وأضافتة</a></li>
                    <li role="presentation"><a href="#basicphotography" aria-controls="basicphotography" role="tab" data-toggle="tab">تصفح الأباء لنذاكر</a></li>
                </ul>
            </div>
            <!-- Vertical tabs end--> 
            ...
            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8 tab_text">
                <div class="tab-content"> 
                    ...
                    <div class="tab-pane fade" id="basicphotography" role="tabpanel">
                        <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    <div class="video_preview"><img src="images/video.gif" alt=""> <a title="تاريخ الرسوم المتحركة من بولندا" class="play-btn rellight" href="http://www.youtube.com/watch?v=2DrXgj1NwN8" data-rel="prettyPhoto"><i class="fa fa-play fa-2"></i></a></div>
                </div>
