...
عند تسجيل على موقع نذاكر يمكنك اضافة الفيديوهات الخاصة بك إلى الموضع وسيتم مراجعتها واضافتها الى دروس موقع نذاكر لتكون متاحة إلى أولياء الأمور والمدرسين يمكن التسجيل من خلال هذا الرابط <a href="' . route('register') . '">اشترك الآن</a>'
                ...
                1 => [
                    ...
                    'desc'  => 'في هذا القسم سنقوم بعرض طريقتين مختلفتين لتسجيل وتصوير الفيديوهات الخاصة بك (التسجيل باستخدام جهاز الكمبيوتر – بالتسجيل باستخدام الكاميرا) ويمكنك استخدام الطريقتين باختلاف نوعية الدرس وطريقة الشرح  قم بالضغط على الطريقة التي تناسب لمعرفة المزيد و الاطلاع على الفيديوهات والبرامج التي تساعدك في تسجيل الفيديوهات الخاصة بك.'
                ],
                2 => [
                    'title' => 'ارسال الفيديو',
